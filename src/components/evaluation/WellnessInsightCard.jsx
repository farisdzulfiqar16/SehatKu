 ...
 * Polished: hover effect, tip pill lebih polished, transisi lebih smooth.
 */
...
export default function WellnessInsightCard({
  ...
  return (
    <div className="rounded-xl border border-gray-100 overflow-hidden transition-all duration-200 hover:border-gray-200 hover:shadow-sm">
      {/* ── Header ── */}
      <div className="flex items-center justify-between px-3.5 py-2.5 bg-gray-50/80">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <span className={`text-xs font-bold tabular-nums ${colorClass}`}>{percent}%</span>
        </div>
      </div>
      ...
      {/* ── Insight ── */}
      {insight && (
        <div className="px-3.5 pb-3 pt-2 bg-white">
