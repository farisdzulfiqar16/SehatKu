/**
 * evaluationData.js
 * Berisi data statis: daftar kategori dan pertanyaan evaluasi.
 * Tidak ada logic di sini — murni data.
 */

export const categories = [
  { id: 'tidur',    label: 'Pola Tidur',        icon: '🌙', color: 'indigo' },
  { id: 'aktivitas',label: 'Aktivitas Fisik',    icon: '🏃', color: 'green'  },
  { id: 'nutrisi',  label: 'Pola Makan',         icon: '🥗', color: 'orange' },
  { id: 'mental',   label: 'Kesehatan Mental',   icon: '🧠', color: 'purple' },
  { id: 'hidrasi',  label: 'Hidrasi',            icon: '💧', color: 'blue'   },
];
